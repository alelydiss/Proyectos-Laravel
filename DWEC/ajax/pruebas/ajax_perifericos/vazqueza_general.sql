...
--
-- Base de datos: `vazqueza_general`
--
CREATE DATABASE IF NOT EXISTS `vazqueza_general` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vazqueza_general`;
